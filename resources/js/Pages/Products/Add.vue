<template #content>
    ...
    <button class="btn btn-primary shadow-md mr-2" @click="confirmUserDeletion">Добавить новый товар</button>
    ...
    <jet-dialog-modal :show="confirmingUserDeletion" @close="closeModal">
        ...
        <template #content>
            ...
            <div class="mt-4">
                <jet-input type="text" class="mt-1 block w-3/4" placeholder="Артикул"
                            ref="sku"
                            v-model="form.sku" />
