    ...
    <div class="mt-4 mx-4">
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            <h2 class="text-lg font-medium mr-auto">
                Редактировать компанию {{company.company_type}} "{{company.name}}"
            </h2>
        ...
        <div class="intro-y box p-5 mt-5">
            ...
            <div class="flex flex-col sm:flex-row items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5">
                ...
                <div class="flex sm:ml-auto mt-5 sm:mt-0">
                    ...
                    <button class="btn btn-primary w-30 ml-2" @click="editCompany">Сохранить</button>
                </div>
...
export default defineComponent({
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                company_ogrnip: this.company.ogrnip,
                company_okpo: this.company.okpo,
                bank_name: this.company.bank_name,
                bank_city: this.company.bank_city,
                bank_rs: this.company.bank_rs,
                bank_ks: this.company.bank_ks,
                bank_bik: this.company.bank_bik,
                company_name: this.company.name,
                company_adress: this.company.adress,
    ...
    mounted(){
        this.dateupdate = moment(this.company.updated_at).format('DD-MM-YYYY')
        //   $("#success-notification-toggle").on("click", function () {  });
    },
    methods: {
        editCompany() {
            this.form.post(route('config.company.edit'), {
                preserveScroll: true,
