                                                        ...
                                                        <div class="product-snippet product-carousel__snippet">
                                                            <a href="#" class="product-snippet__illustration">
                                                                <picture class="product-snippet__picture">
                                                                    <img
                                                                        src="assets/blocks/product-snippet/images/1.png"
                                                    ...
                                                    <div class="product-carousel__slide swiper-slide">
                                                        ...
                                                        <div class="product-snippet product-carousel__snippet">
                                                            <a href="#" class="product-snippet__illustration">
                                                                <picture class="product-snippet__picture">
                                                                    <img
                                                                        src="assets/blocks/product-snippet/images/2.png"
                                                    ...
                                                    <div class="product-carousel__slide swiper-slide">
                                                        ...
                                                        <div class="product-snippet product-carousel__snippet">
                                                            <a href="#" class="product-snippet__illustration">
                                                                <picture class="product-snippet__picture">
                                                                    <img
                                                                        src="assets/blocks/product-snippet/images/3.png"
                                                    ...
                                                    <div class="product-carousel__slide swiper-slide">
                                                        ...
                                                        <div class="product-snippet product-carousel__snippet">
                                                            <a href="#" class="product-snippet__illustration">
                                                                <picture class="product-snippet__picture">
                                                                    <img
                                                                        src="assets/blocks/product-snippet/images/4.png"
                                        ...
                                        <div class="mobile-products">
                                            <div class="mobile-products__container">
                                                <div class="mobile-products__wrapper">
                                                    ...
                                                    <div class="mobile-products__controls">
                                                        <div class="mobile-products__control">
                                                            <!-- begin .button-->
                                                            <div
                                                                class="button button_width_full button_size_l button_style_outline"
                                                            >
                                                                <span class="button__holder">Показать ещё</span>
                                                            </div>
                                                            <!-- end .button-->
                                                        </div>
                                                    </div>
