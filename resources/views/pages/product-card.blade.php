                                ...
                                <div class="tabs__content">
                                    <div class="tabs__panel js-tabs-panel">
                                        <div class="tabs__text">
                                            <p>
                                                Тепловизор RGK TL-400 - это тепловизор промышленного класса, старшая
                                                модель в линейке RGK. С ним можно обследовать как отдельные станки и
                                                электроустановки, так и инспектировать большие объекты под открытым
                                                небом. И все это - с высокой точностью и на безопасном расстоянии.
                                            </p>
                                    ...
                                    <div class="tabs__panel js-tabs-panel">
                                        <div class="tabs__text"><p>Тут характеристики</p></div>
                                    </div>
                                    <div class="tabs__panel js-tabs-panel">
