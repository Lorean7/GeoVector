<x-admin-layout>
    <div class="dashboard__content bg-light-4">
        <div class="row pb-50 mb-10">
            <div class="col-auto">
                <h1 class="text-30 lh-12 fw-700">Обзор</h1>
                <div class="mt-10">Пока тут данные для демонстрации возможностей</div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    ...
                    <div class="py-30 px-30">
                        <div class="y-gap-40">
                            <div class="d-flex ">
                                <img class="size-40" src="{{asset('img/dashboard/avatars/1.png')}}" alt="avatar">
                            ...
                            <div class="d-flex border-top-light">
                                <img class="size-40" src="{{asset('img/dashboard/avatars/2.png')}}" alt="avatar">
                                <div class="ml-10 w-1/1">
                            ...
                            <div class="d-flex border-top-light">
                                <img class="size-40" src="{{asset('img/dashboard/avatars/3.png')}}" alt="avatar">
                                <div class="ml-10 w-1/1">
                            ...
                            <div class="d-flex border-top-light">
                                <img class="size-40" src="{{asset('img/dashboard/avatars/4.png')}}" alt="avatar">
                                <div class="ml-10 w-1/1">
                            ...
                            <div class="d-flex border-top-light">
                                <img class="size-40" src="{{asset('img/dashboard/avatars/5.png')}}" alt="avatar">
                                <div class="ml-10 w-1/1">
                                    <h4 class="text-15 lh-1 fw-500">Guy Hawkins</h4>
                                    <div class="d-flex items-center x-gap-20 y-gap-10 flex-wrap pt-10">
                                        <div class="d-flex items-center">
                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    ...
                    <div class="py-30 px-30">
                        <div class="y-gap-40">
                            <div class="d-flex ">
                                <div class="shrink-0">
                                    <img src="{{asset('img/dashboard/recent-courses/1.png')}}" alt="image">
                                </div>
                                <div class="ml-15">
                                    <h4 class="text-15 lh-16 fw-500">Complete Python Bootcamp From Zero to Hero in Python</h4>
                                    <div class="d-flex items-center x-gap-20 y-gap-10 flex-wrap pt-10">
                                        <div class="d-flex items-center">
                                            <img class="size-16 object-cover mr-8" src="{{asset('img/general/avatar-1.png')}}" alt="icon">
                            ...
                            <div class="d-flex border-top-light">
                                <div class="shrink-0">
                                    <img src="{{asset('img/dashboard/recent-courses/2.png')}}" alt="image">
                                </div>
                                <div class="ml-15">
                            ...
                            <div class="d-flex border-top-light">
                                <div class="shrink-0">
                                    <img src="{{asset('img/dashboard/recent-courses/3.png')}}" alt="image">
                                </div>
                                <div class="ml-15">
