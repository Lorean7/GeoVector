                        ...
                        <div class="geo-list">
                            ...
                            <ul class="geo-list__lists">
                                    ...
                                    <ul class="geo-list__list-item">
                                        <?php foreach ($mainCity as $main) { ?>
                                            <li class="geo-list__item">
                                                <a class="geo-list__link main js-fancybox-close" href="#">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="24"
                                                        height="24"
                                ...
                                <li class="geo-list__list-items">
                                    ...
                                    foreach($otherCity as $key => $other) {
                                        ...
                                        if ($firstLetter != $currentLetter) {
                                            ...
                                            <div class="geo-list__list-title"><?= $currentLetter ?></div>
                                            <ul class="geo-list__list-item">
                                        <?php } ?>
                                            <li class="geo-list__item">
                                                <a class="geo-list__link js-fancybox-close" href="#">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="24"
                                                        height="24"
                                                    ...
                                                    <span class="geo-list__label"><?=$cityName ?></span>
                                                </a>
                                            </li>
                                        <?php
                                        // Получаем следующую букву для следующего литерала
                                        $nextLiteral = isset($otherCity[$key+1]) ? mb_substr($otherCity[$key+1]['city'], 0, 1, 'UTF-8') : '';
                                
                                        if ($nextLiteral != $currentLetter) {
                                            // Если следующая буква отличается от текущей, закрываем текущий список
                                            ?>
                                            </ul>
                                        <?php } ?>
                                    <?php } ?>
