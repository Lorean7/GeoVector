        ...
        <div class="page__container">
            <div class="header__top-wrapper">
                <div class="header__logo">
                    <!-- begin .logo-->
                    <a href="/" class="logo">
                        <img src="assets/blocks/logo/images/Logo-color.svg" alt="GeoVector" class="logo__image"
                            title="" />
                    </a>
                    <!-- end .logo-->
                </div>
                ...
                <div class="header__contact-group">
                    <svg width="41" height="41" viewBox="0 0 41 41" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="header__icon">
                                ...
                                <a class="social-nav__link" href="https://wa.me/79785551516" target="_blank">
                                    <span class="social-nav__icon-wrapper">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear_182_48" x1="766.581" y1="1539.78"
                                                    x2="766.581" y2="0.275879" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#1FAF38" />
                                                    <stop offset="1" stop-color="#60D669" />
                                                </linearGradient>
                                                <linearGradient id="paint1_linear_182_48" x1="793.798" y1="1594.71"
                                                    x2="793.798" y2="0" gradientUnits="userSpaceOnUse">
        ...
        <div class="page__container">
            <div class="header__main-wrapper">
                <div class="header__logo">
                    <!-- begin .logo-->
                    <a href="/" class="logo">
                        <img src="assets/blocks/logo/images/Logo-color-s.svg" alt="GeoVector" class="logo__image"
                            title="" />
                    </a>
                    <!-- end .logo-->
                </div>
                <div class="header__catalog-triggers">
                    ...
                    <div class="button button_width_full button_text-size_s">
                        <span class="button__holder">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="button__icon">
                            ...
                            <span id="button1" class="button__text">Геодезическое оборудование</span>
                                            ...
                                            <span class="catalog-menu__wrapper js-catalog-menu-wrapper">
                                                <ul
                                                    ...
                                                    <li
                                                        ...
                                                        <a href="/catalog.html" class="catalog-menu__panel">
                                                    ...
                                                    <li class="catalog-menu__item js-catalog-menu-item">
                                                        <a href="#" class="catalog-menu__panel">
                                                            <span class="catalog-menu__text">
                                                    ...
                                                    <li class="catalog-menu__item js-catalog-menu-item">
                                                        <a href="#" class="catalog-menu__panel">
                                                            <span class="catalog-menu__text">Нивелиры</span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                                height="10" viewBox="0 0 6 10" fill="none"
                                                                class="catalog-menu__icon">
                                                                <path
                    ...
                    <div class="button button_width_full button_text-size_s">
                        <span class="button__holder">
                            ...
                            <span id="button2" class="button__text">Контрольно-измерительные приборы</span>
                            <span id="menu2" class="button__dropdown-menu">
                                <span class="button__menu-level-1">
                                    <span class="button__catalog-menu">
                                        <!-- begin .catalog-menu-->
                                        <span class="catalog-menu js-catalog-menu">
                                            <span class="catalog-menu__wrapper js-catalog-menu-wrapper">
                                                <ul
                                                    class="catalog-menu__list js-catalog-menu-list js-floating-catalog-max-height">
                                                    <li
                ...
                <div class="header__search">
                    ...
                    <form class="search-form">
                        <div class="search-form__field">
                            <input type="text" class="search-form__input js-search-with-results"
                    ...
                    <div class="geo-selector">
                        <a href="#modalGeoSelect" class="geo-selector__trigger js-modal">
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="geo-selector__icon">
                                <circle cx="14" cy="14" r="13.6585" stroke="#4F4F4F"
                                    stroke-width="0.682927"></circle>
                                <path
                ...
                <div class="header__burger">
                    <!-- begin .button-->
                    <button class="button button_width_full button_size_xs js-toggle" type="button"
                        data-toggle-scope=".page__body" data-toggle-class="page__body_nav_open frozen-scroll"
